...
### AbstractNoGetProperty `virtual` `setonly`
...
### AbstractNoSetProperty `virtual` `readonly`
...
### AbstractProperty `static` `virtual`
...
### PrivateSetterProperty `readonly`
...
| Name | Type | Summary |
| ---- | ---- | ------- |
|Docked|`System.EventHandler`|Summary not provided.|
